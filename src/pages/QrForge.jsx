  ...
  return (
    <div className="max-w-5xl space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[var(--f-ok-bg)] border border-[var(--f-ok)] rounded-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-6">
        ...
        <div className="space-y-5">
          ...
          {/* Permanent URL */}
          <div className="bg-[var(--f-surface-raised)] border border-line rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-ink-3 bg-[var(--f-surface-sunken)] px-2 py-0.5 rounded-full">baked into every printed code</span>
            </div>
            <div className="flex items-center gap-2 bg-bg border border-line rounded-lg px-3 py-2.5">
              ...
              <button
                ...
                className="text-ink-3 hover:text-[var(--f-text)] transition-colors text-xs px-2 py-0.5 rounded"
              >
                Copy
              </button>
            </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <Input
                  ...
                  className="bg-[var(--f-surface-sunken)] border-line text-[var(--f-text)] font-mono text-sm"
                  placeholder="https://..."
                />
              </div>
              <div>
                ...
                {history.length > 0 && (
                  <div className="relative">
                    <button
                      ...
                      className="flex items-center gap-1 text-xs text-ink-2 hover:text-[var(--f-text)] transition-colors px-3 py-2 rounded-lg border border-line hover:border-line-bright"
                    >
                    ...
                    {showHistory && (
                      <div className="absolute top-full mt-1 left-0 w-80 bg-[var(--f-surface-sunken)] border border-line rounded-xl shadow-2xl z-50 overflow-hidden">
                        {history.map((h, i) => (
                          <button
                            key={i}
                          ...
                          >
                            <p className="text-sm text-[var(--f-text)] font-medium truncate">{h.label || 'Unlabelled'}</p>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border text-xs font-medium transition-all ${
                      schemeKey === s.key
                        ...
                        : 'border-line bg-[var(--f-surface-sunken)] text-ink-2 hover:border-line-bright'
                    }`}
                  >
                    {/* Mini swatch */}
                    <span
              ...
              {SIZES.map(({ key, label, sub, Icon }) => {
                ...
                return (
                  <button
                    ...
                    className="flex items-center gap-3 p-3.5 bg-[var(--f-surface-sunken)] hover:bg-line border border-line hover:border-line-bright rounded-xl transition-all group disabled:opacity-60 text-left"
                  >
                    ...
                    <div>
                      <p className="text-sm font-medium text-[var(--f-text)]">{label}</p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[var(--f-surface-raised)] border border-line rounded-xl overflow-hidden">
            ...
            <div className="p-4 space-y-3">
              <div className="flex items-center gap-2 bg-[var(--f-surface-sunken)] rounded-lg px-3 py-2">
              ...
              <div className="bg-[var(--f-surface-sunken)] rounded-xl overflow-hidden border border-line">
                ...
                <div className="p-4 space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-sm font-bold text-[var(--f-text)]">Azaman</p>
          ...
          {/* Info callout */}
          <div className="flex items-start gap-2.5 p-3.5 bg-[var(--f-info)]/8 border border-[var(--f-info)] rounded-xl">
      ...
      <div className="space-y-6 pt-4 border-t border-line">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-bold text-[var(--f-text)] flex items-center gap-2">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-[var(--f-surface-raised)] border border-line rounded-xl p-4 space-y-2">
            <div className="flex items-center justify-between text-ink-2 text-xs font-semibold">
              <span>Total Scans</span>
              <BarChart3 className="w-4 h-4 text-yellow-400" />
            </div>
            <div className="text-2xl font-bold text-[var(--f-text)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-[var(--f-surface-raised)] border border-line rounded-xl p-5 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-semibold text-[var(--f-text)] flex items-center gap-2">
                <BarChart3 className="w-4 h-4 text-yellow-400" />
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute bottom-full mb-2 hidden group-hover:flex flex-col items-center z-30">
                          <div className="bg-bg text-[var(--f-text)] text-[10px] font-semibold py-1 px-2 rounded border border-line shadow-xl whitespace-nowrap">
                    ...
                    {analytics.lastScans.map((scan) => {
                      ...
                      return (
                        <tr key={scan.id} className="hover:bg-surface/40 transition-colors">
                          <td className="py-2.5 px-3 text-[var(--f-text)] whitespace-nowrap font-mono">{dateStr}</td>
        ...
        <div className="bg-[var(--f-surface-raised)] border border-line rounded-xl p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            }} className="bg-emerald-600 hover:bg-emerald-700 text-[var(--f-text)]">
          ...
          {campaignsData?.campaigns && campaignsData.campaigns.length > 0 && (
            <div className="space-y-2">
              {campaignsData.campaigns.map((c) => (
                <div key={c.id} className="flex items-center gap-3 p-3 rounded-lg bg-[var(--f-surface-sunken)] border border-line/50">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-bold text-[var(--f-text)]">{c.name}</span>
                      <span className={`text-[10px] px-1.5 py-0.5 rounded ${c.isActive ? 'bg-[var(--f-ok-bg)] text-[var(--f-ok)]' : 'bg-surface-sunken text-ink-3'}`}>
                  ...
                  <div className="flex gap-1">
                    ...
                    }} className="text-ink-3 hover:text-[var(--f-text)]">
